...
import {
  ...
  CreditCard, Receipt, Scissors, User, Hash, AlertTriangle, Printer,
} from 'lucide-react';
    ...
    <div className="pos-order-pro">
      ...
      {empty ? (
        <div className="pos-order-empty">
          ...
          <p className="text-xs text-slate-500">Pick a product to start the order</p>
        </div>
      ) : (
