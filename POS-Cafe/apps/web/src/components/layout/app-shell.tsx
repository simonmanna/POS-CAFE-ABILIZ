...
const NAV_SECTIONS: NavSection[] = [
  { items: [{ to: '/', label: 'Dashboard', icon: LayoutDashboard }] },
  {
    title: 'Master Data',
    items: [
      { to: '/partners', label: 'Partners', icon: Users, permission: PERMISSIONS.partners.view },
  ...
  },
  {
    title: 'Purchasing',
    items: [
      { to: '/procurement/purchase-requests', label: 'Purchase Requests', icon: ClipboardList, permission: 'purchase_request:read' },
      ...
      { to: '/expenses', label: 'Expenses (Bills)', icon: FileText, permission: 'expense:read' },
              ...
              {items.map((item) => {
                ...
                return (
                  <NavLink
                    ...
                    className={() =>
                      cn(
                        'group relative flex items-center gap-3 rounded-lg px-3 py-2 text-[13.5px] transition-all duration-150',
