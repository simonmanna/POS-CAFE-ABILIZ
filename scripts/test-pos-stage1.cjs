...
const result = spawnSync(process.execPath, [
  ...
  '--testPathPattern=src.*[.]spec|pos-money-foundations|pos-sale-pipeline|pos-store-credit-issuance|pos-cash-flow-go-live|pos-cash-flow-day|pos-cash-flow-adversarial|pos-offline-inventory-replay|pos-shift-close-gates',
