// Lightweight food image / emoji helpers. Tries a free Unsplash query,
// falls back to a category-themed gradient + emoji.
...
const CATEGORY_EMOJI: Record<string, string> = {
  ...
  bakery: '🥐', bread: '🍞',
  kids: '🧃', combo: '🍱', special: '⭐', offers: '🏷️', breakfast_menu: '🌅',
};
