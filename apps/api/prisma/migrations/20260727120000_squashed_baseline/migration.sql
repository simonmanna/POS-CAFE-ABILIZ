...
-- CreateEnum
CREATE TYPE "CostingMethod" AS ENUM ('AVCO', 'FIFO', 'STANDARD', 'SPECIFIC');
...
-- CreateEnum
CREATE TYPE "AuditAction" AS ENUM ('create', 'update', 'delete', 'login', 'logout', 'approve', 'reject', 'post', 'cancel', 'receive', 'issue', 'adjust', 'transfer', 'reconcile', 'merge', 'clean', 'reserve', 'reprint', 'assign', 'unassign', 'restore', 'measure');

-- CreateEnum
CREATE TYPE "TaskType" AS ENUM ('ONE_TIME', 'RECURRING', 'SHIFT', 'OPENING', 'CLOSING', 'CLEANING', 'MAINTENANCE', 'INVENTORY', 'AUDIT', 'PURCHASE', 'INCIDENT', 'COMPLIANCE', 'FOOD_SAFETY', 'EQUIPMENT_INSPECTION', 'CUSTOM');

-- CreateEnum
CREATE TYPE "TaskPriority" AS ENUM ('CRITICAL', 'HIGH', 'MEDIUM', 'LOW', 'OPTIONAL');

-- CreateEnum
CREATE TYPE "TaskMgmtStatus" AS ENUM ('DRAFT', 'PENDING', 'ASSIGNED', 'IN_PROGRESS', 'WAITING', 'REVIEW', 'VERIFIED', 'COMPLETED', 'CANCELLED', 'SKIPPED', 'OVERDUE');

-- CreateEnum
CREATE TYPE "TaskCategory" AS ENUM ('OPENING', 'CLOSING', 'CLEANING', 'KITCHEN', 'COFFEE_BAR', 'DINING_AREA', 'RETAIL_FLOOR', 'WAREHOUSE', 'INVENTORY', 'PURCHASING', 'ACCOUNTING', 'CASH_MANAGEMENT', 'SECURITY', 'MAINTENANCE', 'EQUIPMENT', 'MARKETING', 'COMPLIANCE', 'AUDIT', 'CUSTOMER_SERVICE', 'CUSTOM');

-- CreateEnum
CREATE TYPE "TaskArea" AS ENUM ('KITCHEN', 'COFFEE_STATION', 'BAR', 'DINING_AREA', 'RETAIL_FLOOR', 'WAREHOUSE', 'OFFICE', 'CASHIER', 'STORAGE', 'DELIVERY', 'RESTROOM', 'PARKING', 'OTHER');

-- CreateEnum
CREATE TYPE "RecurrenceType" AS ENUM ('HOURLY', 'EVERY_X_HOURS', 'DAILY', 'WEEKDAYS', 'WEEKENDS', 'WEEKLY', 'MONTHLY', 'QUARTERLY', 'YEARLY', 'CUSTOM_DATES', 'SPECIFIC_SHIFT', 'AFTER_COMPLETION');

-- CreateEnum
CREATE TYPE "TaskNotificationChannel" AS ENUM ('IN_APP', 'PUSH', 'SMS', 'EMAIL', 'WHATSAPP', 'TELEGRAM');

-- CreateEnum
CREATE TYPE "VerificationMethod" AS ENUM ('MANAGER_PIN', 'PASSWORD', 'BIOMETRIC', 'DIGITAL_SIGNATURE', 'PHOTO_PROOF');
...
-- CreateEnum
CREATE TYPE "ReportSection" AS ENUM ('current_assets', 'non_current_assets', 'current_liabilities', 'long_term_liabilities', 'equity', 'revenue', 'contra_revenue', 'cogs', 'operating_expense', 'other_income', 'other_expense', 'off_balance');
...
-- CreateEnum
CREATE TYPE "StockMoveType" AS ENUM ('receipt', 'issue', 'adjustment_in', 'adjustment_out', 'transfer_in', 'transfer_out', 'opening_balance', 'waste', 'return_in', 'return_to_supplier', 'expiry_write_off', 'internal_use', 'promo_sample');

-- CreateEnum
CREATE TYPE "InventoryMovementType" AS ENUM ('STOCK_IN', 'STOCK_OUT', 'STOCK_TRANSFER_OUT', 'STOCK_TRANSFER_IN', 'ADJUSTMENT_GAIN', 'ADJUSTMENT_LOSS', 'WASTE', 'EXPIRY_WRITE_OFF', 'RETURN_RESTOCK', 'RETURN_TO_SUPPLIER', 'INTERNAL_CONSUMPTION', 'PROMO_SAMPLE', 'PRODUCTION_CONSUME', 'PRODUCTION_OUTPUT', 'REVALUATION');
...
-- CreateEnum
CREATE TYPE "PosTableStatus" AS ENUM ('available', 'occupied', 'reserved', 'out_of_service', 'cleaning');
...
-- CreateEnum
CREATE TYPE "DiscountSource" AS ENUM ('manual', 'promotion', 'loyalty', 'coupon', 'customer_discount', 'group_discount', 'membership_discount', 'global_promotion');
...
-- CreateEnum
CREATE TYPE "AssetStatus" AS ENUM ('active', 'under_maintenance', 'disposed', 'lost_stolen', 'in_repair', 'reserved');

-- CreateEnum
CREATE TYPE "AcquisitionMethod" AS ENUM ('purchased', 'donated', 'leased', 'constructed', 'transferred_in', 'gifted');

-- CreateEnum
CREATE TYPE "DepreciationMethod" AS ENUM ('straight_line', 'declining_balance', 'double_declining', 'units_of_production', 'manual');

-- CreateEnum
CREATE TYPE "DisposalMethod" AS ENUM ('sold', 'scrapped', 'donated', 'lost', 'stolen', 'destroyed');

-- CreateEnum
CREATE TYPE "MaintenanceType" AS ENUM ('preventive', 'corrective', 'emergency', 'scheduled', 'calibration');

-- CreateEnum
CREATE TYPE "AssignmentEntityType" AS ENUM ('employee', 'teacher', 'student', 'department', 'branch', 'room', 'vehicle', 'clinic', 'store');
...
CREATE TABLE "Partner" (
    ...
    "discountPercentOverride" DECIMAL(9,4) NOT NULL DEFAULT 0,
    "gender" TEXT,
...
CREATE TABLE "Product" (
    ...
    "salesUomId" TEXT,
    "recipeUomId" TEXT,
    "productionUomId" TEXT,
    "allowFractionalSale" BOOLEAN NOT NULL DEFAULT true,
    "minSaleQty" DECIMAL(20,6),
    "maxSaleQty" DECIMAL(20,6),
    "taxId" TEXT,
    ...
    "pickingStrategy" "PickingStrategy" NOT NULL DEFAULT 'FEFO',
    "hasVariants" BOOLEAN NOT NULL DEFAULT false,
    "incomeAccountOverrideId" TEXT,
    "expenseAccountOverrideId" TEXT,
    "inventoryAccountOverrideId" TEXT,
    "cogsAccountOverrideId" TEXT,
    "shrinkageAccountOverrideId" TEXT,
    "damageAccountOverrideId" TEXT,
    "expiryAccountOverrideId" TEXT,
    "varianceGainAccountOverrideId" TEXT,
    ...
    "maxQuantity" DECIMAL(20,6) NOT NULL DEFAULT 0,
    "stockPolicy" "PosStockPolicy" NOT NULL DEFAULT 'silent',
    "taxInclusive" BOOLEAN NOT NULL DEFAULT false,
    "measurementMethod" "MeasurementMethod" NOT NULL DEFAULT 'count',
    "containerVolumeMl" DECIMAL(20,6),
    "emptyBottleWeightG" DECIMAL(20,6),
    "actualEmptyWeightG" DECIMAL(20,6),
    "fullBottleWeightG" DECIMAL(20,6),
    "liquidWeightG" DECIMAL(20,6),
    "conversionFactorMlPerG" DECIMAL(20,10),
    "standardPourMl" DECIMAL(20,6),
    "allowPartialBottle" BOOLEAN NOT NULL DEFAULT true,
    "varianceToleranceG" DECIMAL(20,6),
    "isActive" BOOLEAN NOT NULL DEFAULT true,
    "customFields" JSONB NOT NULL DEFAULT '{}',
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,
...
CREATE TABLE "ProductCategory" (
    ...
    "cogsAccountId" TEXT,
    "shrinkageAccountId" TEXT,
    "damageAccountId" TEXT,
    "expiryAccountId" TEXT,
    "varianceGainAccountId" TEXT,
    "promoExpenseAccountId" TEXT,
    "internalUseAccountId" TEXT,
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,
    "createdBy" TEXT,
    "updatedBy" TEXT,
...
CREATE TABLE "UnitOfMeasure" (
    ...
    "roundingPrecision" DECIMAL(18,6) NOT NULL DEFAULT 0.000001,
    "uomType" TEXT NOT NULL DEFAULT 'reference',
...
CREATE TABLE "JournalEntry" (
    ...
    "sourceType" TEXT,
    "sourceId" TEXT,
    "postingType" TEXT NOT NULL DEFAULT 'primary',
    "postingKey" TEXT,
    "branchId" TEXT,
    "costCenterId" TEXT,
...
CREATE TABLE "Order" (
    ...
    "transactionDiscountType" "DiscountType" NOT NULL DEFAULT 'percentage',
    "transactionDiscountAmount" DECIMAL(20,6) NOT NULL DEFAULT 0,
    "discountReason" TEXT,
    "discountSource" "DiscountSource" NOT NULL DEFAULT 'manual',
    "openedAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "closedAt" TIMESTAMP(3),
    "cancelledAt" TIMESTAMP(3),
    "cancelReason" TEXT,
...
-- CreateTable
CREATE TABLE "InventoryPostingRule" (
    "id" TEXT NOT NULL,
    "organizationId" TEXT NOT NULL,
...
CREATE TABLE "Task" (
    ...
    "title" TEXT NOT NULL,
    "description" TEXT,
    "taskType" "TaskType" NOT NULL DEFAULT 'ONE_TIME',
    "priority" "TaskPriority" NOT NULL DEFAULT 'MEDIUM',
    "status" "TaskMgmtStatus" NOT NULL DEFAULT 'PENDING',
...
-- CreateTable
CREATE TABLE "TaskRecurringTemplate" (
    "id" TEXT NOT NULL,
    "organizationId" TEXT NOT NULL,
    "title" TEXT NOT NULL,
    "description" TEXT,
...
-- CreateIndex
CREATE INDEX "AccountMapping_organizationId_accountId_idx" ON "AccountMapping"("organizationId", "accountId");
...
-- CreateIndex
CREATE INDEX "InventoryPostingRule_organizationId_movementType_productId_idx" ON "InventoryPostingRule"("organizationId", "movementType", "productId");

-- CreateIndex
CREATE INDEX "InventoryPostingRule_organizationId_movementType_categoryId_idx" ON "InventoryPostingRule"("organizationId", "movementType", "categoryId");

-- CreateIndex
CREATE UNIQUE INDEX "InventoryPostingRule_organizationId_movementType_lineIndex__key" ON "InventoryPostingRule"("organizationId", "movementType", "lineIndex", "productId", "categoryId");
...
-- CreateIndex
CREATE INDEX "Asset_organizationId_barcode_idx" ON "Asset"("organizationId", "barcode");

-- CreateIndex
CREATE INDEX "Asset_organizationId_serialNumber_idx" ON "Asset"("organizationId", "serialNumber");

-- CreateIndex
CREATE UNIQUE INDEX "Asset_organizationId_assetCode_key" ON "Asset"("organizationId", "assetCode");

-- CreateIndex
CREATE UNIQUE INDEX "AssetAcquisition_assetId_key" ON "AssetAcquisition"("assetId");

-- CreateIndex
CREATE INDEX "AssetAcquisition_organizationId_idx" ON "AssetAcquisition"("organizationId");
...
-- CreateIndex
CREATE INDEX "AssetDepreciation_organizationId_idx" ON "AssetDepreciation"("organizationId");
...
-- CreateIndex
CREATE UNIQUE INDEX "AssetDepreciation_organizationId_assetId_period_key" ON "AssetDepreciation"("organizationId", "assetId", "period");
...
-- CreateIndex
CREATE INDEX "AssetRepair_organizationId_idx" ON "AssetRepair"("organizationId");
...
-- CreateIndex
CREATE INDEX "AssetWarranty_assetId_idx" ON "AssetWarranty"("assetId");

-- CreateIndex
CREATE INDEX "AssetWarranty_organizationId_warrantyEnd_idx" ON "AssetWarranty"("organizationId", "warrantyEnd");

-- CreateIndex
CREATE INDEX "AssetInsurance_organizationId_idx" ON "AssetInsurance"("organizationId");

-- CreateIndex
CREATE INDEX "AssetInsurance_assetId_idx" ON "AssetInsurance"("assetId");

-- CreateIndex
CREATE INDEX "AssetInsurance_organizationId_renewalDate_idx" ON "AssetInsurance"("organizationId", "renewalDate");

-- CreateIndex
CREATE INDEX "AssetInspection_organizationId_idx" ON "AssetInspection"("organizationId");
...
-- CreateIndex
CREATE INDEX "AssetRevaluation_organizationId_idx" ON "AssetRevaluation"("organizationId");

-- CreateIndex
CREATE INDEX "AssetRevaluation_assetId_idx" ON "AssetRevaluation"("assetId");

-- CreateIndex
CREATE INDEX "AssetCheckInOut_organizationId_idx" ON "AssetCheckInOut"("organizationId");

-- CreateIndex
CREATE INDEX "AssetCheckInOut_assetId_idx" ON "AssetCheckInOut"("assetId");

-- CreateIndex
CREATE INDEX "AssetCheckInOut_assetId_status_idx" ON "AssetCheckInOut"("assetId", "status");

-- CreateIndex
CREATE INDEX "AssetDocument_organizationId_idx" ON "AssetDocument"("organizationId");
...
-- CreateIndex
CREATE INDEX "Task_organizationId_branchId_idx" ON "Task"("organizationId", "branchId");
...
-- CreateIndex
CREATE INDEX "Task_organizationId_createdBy_idx" ON "Task"("organizationId", "createdBy");

-- CreateIndex
CREATE INDEX "Task_organizationId_shiftId_idx" ON "Task"("organizationId", "shiftId");

-- CreateIndex
CREATE INDEX "Task_organizationId_taskType_idx" ON "Task"("organizationId", "taskType");
...
-- CreateIndex
CREATE INDEX "TaskChecklistItem_organizationId_idx" ON "TaskChecklistItem"("organizationId");
...
-- CreateIndex
CREATE INDEX "TaskActivityLog_organizationId_idx" ON "TaskActivityLog"("organizationId");

-- CreateIndex
CREATE INDEX "TaskLabel_organizationId_idx" ON "TaskLabel"("organizationId");

-- CreateIndex
CREATE UNIQUE INDEX "TaskLabel_organizationId_name_key" ON "TaskLabel"("organizationId", "name");

-- CreateIndex
CREATE INDEX "TaskAutoRule_organizationId_idx" ON "TaskAutoRule"("organizationId");

-- CreateIndex
CREATE INDEX "TaskAutoRule_organizationId_triggerEvent_idx" ON "TaskAutoRule"("organizationId", "triggerEvent");

-- CreateIndex
CREATE INDEX "TaskRecurringTemplate_organizationId_idx" ON "TaskRecurringTemplate"("organizationId");

-- CreateIndex
CREATE INDEX "_UserRoles_B_index" ON "_UserRoles"("B");

-- CreateIndex
CREATE INDEX "_TaskLabelLink_B_index" ON "_TaskLabelLink"("B");
...
-- AddForeignKey
ALTER TABLE "AssetAcquisition" ADD CONSTRAINT "AssetAcquisition_assetId_fkey" FOREIGN KEY ("assetId") REFERENCES "Asset"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "AssetRevaluation" ADD CONSTRAINT "AssetRevaluation_assetId_fkey" FOREIGN KEY ("assetId") REFERENCES "Asset"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "AssetCheckInOut" ADD CONSTRAINT "AssetCheckInOut_assetId_fkey" FOREIGN KEY ("assetId") REFERENCES "Asset"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "_TaskLabelLink" ADD CONSTRAINT "_TaskLabelLink_A_fkey" FOREIGN KEY ("A") REFERENCES "Task"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "_TaskLabelLink" ADD CONSTRAINT "_TaskLabelLink_B_fkey" FOREIGN KEY ("B") REFERENCES "TaskLabel"("id") ON DELETE CASCADE ON UPDATE CASCADE;
